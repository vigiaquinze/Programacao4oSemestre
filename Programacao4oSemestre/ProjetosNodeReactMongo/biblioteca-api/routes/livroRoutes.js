...
router.put('/:id', livroController.atualizarLivro);      // Atualizar um livro por ID com PUT
router.patch('/:id', livroController.atualizarParcialmenteLivro); // Atualizar parcialmente um livro por ID
